<template>
  <app-page>
    <app-form ref="form" :model="buildData" label-width="80px" @save="save">
      <app-formitem label="姓名">
        <app-input v-model="buildData.name"></app-input>
      </app-formitem>
      <app-formitem label="手机">
        <app-input v-model="buildData.manager"></app-input>
      </app-formitem>
      <app-formitem label="生日">
        <app-input :time-start-options="timeStartOptions" :time-end-options="timeEndOptions" type="date" v-model="buildData.birthday"></app-input>
      </app-formitem>
      <app-formitem label="工号">
        <app-input v-model="buildData.manager"></app-input>
      </app-formitem>
      <app-formitem label="基本评语">
