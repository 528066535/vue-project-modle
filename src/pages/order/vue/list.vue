  ...
  <div>
    ...
    <div class="table-container">
      <app-table ref="table" :paging="false" :local-data="tableData" :param="getParams()">
        ...
        <el-table-column label="预约包厢" prop="email" align="center"></el-table-column>
        <el-table-column label="预约商品信息" prop="addrcity" align="center"></el-table-column>
        <el-table-column label="预约时间" prop="age" align="center"></el-table-column>
        <el-table-column label="预约单归属人" prop="addrcity" align="center"></el-table-column>
...
<script>
  ...
  export default {
    ...
    methods:{
      ...
      open(row = null) {
        import(/* webpackChunkName: "pages/business/dialog/order-detail" */'../dialog/order-detail').then(component => {
