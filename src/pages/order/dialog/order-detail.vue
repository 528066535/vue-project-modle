<template>
  <app-page>
    <app-form ref="form" :model="buildData" label-width="80px" @save="save">
      <app-formitem label="客户姓名">
        <app-input v-model="buildData.name"></app-input>
      </app-formitem>
      <app-formitem label="客户手机">
        <app-input v-model="buildData.manager"></app-input>
      </app-formitem>
      <app-formitem label="预约时间">
        <app-input :time-start-options="timeStartOptions" :time-end-options="timeEndOptions" type="datetime" v-model="buildData.birthday"></app-input>
      </app-formitem>
      <app-formitem label="预约大小">
        <app-input v-model="buildData.manager"></app-input>
      </app-formitem>
      <app-formitem label="商品信息">
        <app-input v-model="buildData.manager"></app-input>
      </app-formitem>
      <app-formitem label="归属人">
        <app-input v-model="buildData.manager"></app-input>
      </app-formitem>
      <app-formitem label="其他需求">
        <app-input type="textarea" v-model="buildData.manager"></app-input>
      </app-formitem>
    </app-form>
  </app-page>
</template>
