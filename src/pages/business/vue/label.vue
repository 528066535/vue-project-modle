<template>
  <div>
    <app-condition>
      ...
      <div slot="toolbar">
        <app-button @click="addBus" icon="add">新增</app-button>
        <app-button @click="addBus" icon="add">批量下架</app-button>
      </div>
    </app-condition>
    <div class="table-container">
      <app-table ref="table" :paging="false" :local-data="tableData" :param="getParams()">
        <el-table-column label="标签名称" prop="loginname" align="center"></el-table-column>
        <el-table-column label="上架状态" prop="nickname" align="center"></el-table-column>
        <el-table-column  label="操作" align="center" width="310">
          <template slot-scope="scope">
            <app-button icon="edit" size="mini" @click="edit(scope.row)">下架</app-button>
